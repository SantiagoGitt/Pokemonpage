...
/*let soymaestropokemon= prompt ("¿Eres un maestro pokemon?");

if (soymaestropokemon=="si"){
    alert("Puedes elegir tu pokemon!!");
}else{
    alert("Debes entrenar primero");
}

let npokemon= prompt("¿Cuantos pokemon mereces?")

while (npokemon != "1") {
    alert ("Son demasiados pokemons, deja algo para los demas");
    npokemon= prompt ("ingresa otra cantidad");
    alert ("ya puedes elegir tu nuevo pokemon!")
}
*/
const Entrenador=document.querySelector(".uno")
localStorage.setItem('entrenador', '');
